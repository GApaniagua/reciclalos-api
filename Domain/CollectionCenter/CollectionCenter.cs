...
public class CollectionCenter
{
    ...
    public int Id { get; set; }            // Ejemplo: "Coca-cola zona 17"
    public string Name { get; set; }            // Ejemplo: "Coca-cola zona 17"
    ...
    public string Materials { get; set; } // Ejemplo: ["et fugiat aute", "culpa velit in"]
